...
train_text, val_text, train_labels, val_labels =  train_test_split(sentences, labels, test_size=0.1, random_state=36)

# load a pre-trained BERT tokenizer and model
device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
tokenizer = BertTokenizer.from_pretrained('D:\esg_bert\model')
bert_model = BertForSequenceClassification.from_pretrained('D:\esg_bert\model', num_labels=4)
